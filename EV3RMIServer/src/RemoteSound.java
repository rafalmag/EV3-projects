...
public class RemoteSound extends UnicastRemoteObject implements Sound {
	...
	public void systemSound(boolean aQueued, int aCode) throws RemoteException {
		lejos.hardware.Sound.systemSound(aQueued, aCode);
	}
