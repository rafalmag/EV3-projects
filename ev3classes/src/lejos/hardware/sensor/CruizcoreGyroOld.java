 ...
 * @version 1.0
 */
public class CruizcoreGyroOld extends I2CSensor implements Gyroscope, Accelerometer {
...
//	private static final byte ACCEL_Z = 0x4A; // 0x4B (2 Bytes)
	 ...
	 */
    public CruizcoreGyroOld(I2CPort port) {
        super(port, GYRO_ADDRESS);
    }
    
    public CruizcoreGyroOld(Port port) {
        super(port, GYRO_ADDRESS);
    }
